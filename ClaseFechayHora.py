class FechaHora:
    ...
    def Mostrar(self):
        print('{0}/{1}/{2} - {3}:{4}:{5}'.format(self.__dia, self.__mes, self.__año, self.__hora, self.__minutos, self.__segundos))

    def PonerEnHora(self, h = __hora, m= __minutos, s= __segundos):
        self.__hora = h
        self.__minutos = m
        self.__segundos = s
